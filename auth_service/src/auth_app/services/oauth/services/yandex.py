...
class OAuthYandexService(OAuthBaseService):
    async def authorize(
        self,
        oauth_info: dict,
        user_agent: str | None,
        ...
        email = oauth_info["default_email"]
        ...
        self.logger.info("Yandex OAuth", email=email)
        return jwt.tokens
    ...
    async def bind(
        ...
        self.logger.info("Bind Yandex OAuth", email=email, user_id=user_id)
